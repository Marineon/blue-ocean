...
class PhotosContextProvider extends Component {
  state = {
    ...
    myAlbums:[{title: 'Really Really Long name Test Album 1', description: 'Simple Test Album', owner:'Jun', permission:0, photos: [6,7,10,12], tags: ['test1', 'test2', 'test3']},
    ...
    friendsAlbums: [
      {title: 'Friend Album 1', description: 'Simple Test Album', owner:'NotJun', permission:0, photos: [6,7,10,12], tags: ['test1', 'test2', 'test3']},
      {title: 'Friend Album 2', description: 'Simple Test Album', owner:'NotJun', permission:0, photos: [6,7,10,12], tags: ['test1', 'coachella', 'test3']},
      {title: 'Friend Album 3', description: 'Simple Test Album', owner:'NotJun', permission:0, photos: [6,7,10,12], tags: ['pineapple', 'test2', 'test3']},
    ],
    publicAlbums: [
      {title: 'Public Album 1', description: 'Simple Test Album', owner:'ProbablyNotJun', permission:0, photos: [6,7,10,12], tags: ['test1', 'test2', 'test3']},
      {title: 'Public Album 2', description: 'Simple Test Album', owner:'ProbablyNotJun', permission:0, photos: [6,7,10,12], tags: ['test1', 'coachella', 'test3']},
      {title: 'Public Album 3', description: 'Simple Test Album', owner:'ProbablyNotJun', permission:0, photos: [6,7,10,12], tags: ['pineapple', 'test2', 'test3']},
    ],
  }

  setPhotos = (myPhotos, friendsPhotos, publicPhotos) => {
    this.setState({ myPhotos })
    if(friendsPhotos && publicPhotos){
      this.setState({
        friendsPhotos, publicPhotos
      })
    }
  }

  setAlbums = (myAlbums, friendsAlbums, publicAlbums) => {
    this.setState({ myAlbums })
    if(friendsAlbums && publicAlbums){
      this.setState({
        friendsAlbums, publicAlbums
      })
    }
  }
  ...
  render() {
    return(
      <PhotosContext.Provider value={{...this.state, albums: this.state.albums, updatePhoto:this.updatePhoto, setPhotos:this.setPhotos}}>
        {this.props.children}
